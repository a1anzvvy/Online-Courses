...
def im_detect(net, im, boxes=None, boxscores=None):
    ...
    # construct blob for boxscores
    blobs['boxscores'] = boxscores      # 2202
    # blobs['boxscores'] = blobs['boxscores'][]
    # print(boxscores.shape)
    # time.sleep(1000)
    ...
    # print(net.blobs['boxscores'].data.shape)
    ...
    if cfg.TEST.SVM:
        ...
        # TODO: what to fill in the background place
        scores = blobs_out['cls_prob']
        scores = np.hstack((np.zeros((scores.shape[0], 1), dtype=np.float32), scores))     # stack background with prob 1
        # print(scores)
        # print(scores.shape)
        # time.sleep(1000)
